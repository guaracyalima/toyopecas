      ...
      <section class="l-container">
                  ...
                  <li>
                    ...
                    <div class="widget-profile profile-in-header">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        ...
                        <li class="lock"><a href="#"><i class="fa fa-lock"></i>Log Out</a></li>
                        <li class="power"><a href="#"><i class="fa fa-power-off"></i>Sign Out</a></li>
                      </ul>
                    </div>
                  </li>
                </ul>
        ...
        <div class="l-spaced-vertical">
          <div class="l-box no-border">
            <div class="l-spaced">
              <h3>Gerenciar seção de conteudo do topo</h3>
              {!! Form::open(['route' => 'admin.topo.store', 'class' => 'form']) !!}
              ...
              <div class="form-group">
                ...
                {!! Form::text('descricao', null ,['class' => 'form-control', 'placeholder' => 'Lorem ipsun...']) !!}
              </div>
